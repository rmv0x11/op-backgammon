...
func MatchesForDB(m *model.Match) *storage.Match {
	return &storage.Match{
		...
		PlayerOneLose:   sql.NullInt64{m.PlayerOneLose, true},
		PlayerTwoLose:   sql.NullInt64{m.PlayerTwoLose, true},
		PlayerOneWin:    sql.NullInt64{m.PlayerOneWin, true},
		PlayerTwoWin:    sql.NullInt64{m.PlayerTwoWin, true},
